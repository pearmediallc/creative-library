...
export const fileRequestApi = {
  ...
  // Reorder files within a request (by media file IDs)
  reorderFiles: (requestId: string, orderedFileIds: string[]) =>
    api.patch(`/file-requests/${requestId}/reorder`, { ordered_file_ids: orderedFileIds }),
