                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2 col-span-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['team_lead', 'assistant_team_lead', 'vertical_head', 'ceo', 'head_media_buying', 'creative_head'].map(r => (
                  ...
                  {(['team_lead', 'assistant_team_lead', 'creative'].includes(formData.role) ||
                    formData.additional_roles?.some(r => ['vertical_head', 'team_lead', 'assistant_team_lead'].includes(r))) && (
                    <div className="space-y-2 col-span-2">
